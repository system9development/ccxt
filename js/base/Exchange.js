"use strict";
// NOTE: This import is meant to be used in combination with the feat/winston_request_logging branch off s9ui, otherwise they'll break the program
const functions = require('./functions')
const logger = require('../../../../src/logger/serv_logger.ts');
// ----------------------------------------------------------------------------
const myLogger = logger.logger(__filename);
const {
    isNode
    , keys
    , values
...
const string = require('ccxt/js/base/functions/string');
...
module.exports = class Exchange {
    ...
    initRestRateLimiter() {
        ...
        this.executeRestRequest = (url, method = 'GET', headers = undefined, body = undefined) => {
            ...
            myLogger.info(`REQUEST: Method: ${method} url: ${url} Exchange: ${this.id}`);
    ...
    handleErrors(statusCode, statusText, url, method, responseHeaders, responseBody, response, requestHeaders, requestBody) {
        myLogger.error(`Method: ${method} url: ${url} StatusCode: ${statusCode} `)
    }
    ...
    handleRestResponse(response, url, method = 'GET', requestHeaders = undefined, requestBody = undefined) {
        ...
        return response.text().then((responseBody) => {
            ...
            myLogger.info(`RESPONSE: Method: ${method} url: ${url} Exchange: ${this.id} StatusCode: ${response.status}`);
