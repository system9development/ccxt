...
module.exports = class Exchange {
    ...
    initRestRateLimiter() {
        ...
        this.executeRestRequest = (url, method = 'GET', headers = undefined, body = undefined) => {
            ...
            req_logger.info(`REQUEST: Method: ${method} url: ${url} Exchange: ${this.id}`);
    ...
    handleErrors(statusCode, statusText, url, method, responseHeaders, responseBody, response, requestHeaders, requestBody) {
        // override me
        req_logger.error(`Method: ${method} url: ${url} StatusCode: ${statusCode} `)
    }
    ...
    handleRestResponse(response, url, method = 'GET', requestHeaders = undefined, requestBody = undefined) {
        ...
        return response.text().then((responseBody) => {
            ...
            req_logger.info(`RESPONSE: Method: ${method} url: ${url} Exchange: ${this.id} StatusCode: ${response.status}`);
