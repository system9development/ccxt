...
use ccxt\abstract\coinstore as Exchange;
...
class coinstore extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
         ...
         */
        $response = $this->publicPostV2PublicConfigSpotSymbols ();
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->publicGetApiV1MarketTradeSymbol (array_merge($request, $params));
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) {
        ...
        $response = $this->publicGetApiV1MarketDepthSymbol (array_merge($request, $params));
    ...
    public function fetch_balance($params = array ()) {
         ...
         */
        $this->load_markets();
        $response = $this->privatePostApiSpotAccountList ();
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        ...
        $response = $this->privatePostApiTradeOrderPlace (array_merge($request, $params));
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) {
        ...
        $response = $this->privatePostApiTradeOrderCancel (array_merge($request, $params));
    ...
    public function cancel_all_orders($symbol = null, $params = array ()) {
        ...
        $cancelResponse = $this->privatePostApiTradeOrderCancelAll (array_merge($request, $params));
        ...
        try {
            $orderResponse = $this->fetch_orders($symbol, null, null, array( 'endTime' => $endTimestamp, 'ordType' => 'LIMIT' ));
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->privateGetApiTradeOrderHistoryOrders (array_merge($request, $params));
        $data = $this->safe_value($response, 'data');
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->privateGetApiV2TradeOrderActive (array_merge($request, $params));
        $data = $this->safe_value($response, 'data');
        if ($since !== null || $limit !== null) {
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->privateGetApiTradeMatchAccountMatches (array_merge($request, $params));
        $trades = $this->safe_value($response, 'data', array());
