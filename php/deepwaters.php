...
use ccxt\abstract\deepwaters as Exchange;
...
class deepwaters extends Exchange {
    ...
    public function fetch_ticker($symbol, $params = array ()) {
        ...
        $tickers = $this->fetch_tickers(array( $symbol ));
        if (strlen($tickers) === 0) {
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) {
        ...
        $response = null;
        if ($isVenueId) {
            $response = $this->privateGetOrdersByVenueOrderIdId ($params);
        } else {
            $response = $this->privateGetOrdersByCustomerObjectIdId ($params);
        }
        $success = $this->safe_value($response, 'success', false);
        if (!$success) {
            throw $this->handle_error($response);
