...
use ccxt\async\abstract\pintu as Exchange;
use ccxt\BadRequest;
use ccxt\Precise;
use React\Async;
...
class pintu extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            */
            $response = Async\await($this->publicGetPublicGetSymbolsReference ());
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            */
            ...
            $response = Async\await($this->publicGetPublicGetBook (array_merge($request, $params)));
    ...
    public function fetch_balance($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            */
            Async\await($this->load_markets());
            $response = Async\await($this->privatePostPrivateGetAccountInformation ());
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            */
            ...
            $response = Async\await($this->privatePostPrivatePlaceOrder (array_merge($request, $params)));
            $timestamp = $this->safe_timestamp($response, 'timestamp');
    ...
    public function cancel_order($id, $symbol, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            */
            ...
            Async\await($this->privatePostPrivateCancelOrder (array_merge($request, $params)));
            // {
    ...
    public function fetch_orders($symbol, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            */
            ...
            $response = Async\await($this->privatePostPrivateGetOrderHistory (array_merge($request, $params)));
            // {
            //     "request_id" => "a88b9054-bde2-4fd7-8a4e-c6ff6de212e2",
            //     "timestamp" => 16775774798300,
    ...
    public function fetch_open_orders($symbol, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            */
            ...
            $response = Async\await($this->privatePostPrivateGetOpenOrders (array_merge($request, $params)));
            // "data" => {
            //     "count" => 345,
            //     "orders" => array(
            //       array(
    ...
    public function fetch_my_trades($symbol, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            */
            ...
            $response = Async\await($this->privatePostPrivateGetTradeHistory (array_merge($request, $params)));
    ...
    public function fetch_order($id, $symbol, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            */
            ...
            $response = Async\await($this->privatePostPrivateGetOrderDetails (array_merge($request, $params)));
