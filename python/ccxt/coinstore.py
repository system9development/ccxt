...
class coinstore(Exchange):
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['size'] = limit
        response = self.publicGetApiV1MarketTradeSymbol(self.extend(request, params))
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        if limit is not None:
            request['depth'] = limit
        response = self.publicGetApiV1MarketDepthSymbol(self.extend(request, params))
    ...
    def fetch_tickers(self, symbols=None, params={}):
        ...
        for i in range(0, len(ids)):
            ids[i] = ids[i].upper()
        response = self.publicGetApiV1MarketTickers(params)
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = self.privatePostApiTradeOrderPlace(self.extend(request, params))
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        response = self.privatePostApiTradeOrderCancel(self.extend(request, params))
    ...
    def cancel_all_orders(self, symbol=None, params={}):
        ...
        cancelResponse = self.privatePostApiTradeOrderCancelAll(self.extend(request, params))
        ...
        try:
            orderResponse = self.fetch_orders(symbol, None, None, {'endTime': endTimestamp, 'ordType': 'LIMIT'})
    ...
    def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = self.privateGetApiTradeOrderHistoryOrders(self.extend(request, params))
        data = self.safe_value(response, 'data')
    ...
    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        :returns [dict]: a list of `order structures <https://docs.ccxt.com/#/?id=order-structure>`
        """
        # parsedOrders = self.fetch_orders(symbol, None, None, params)
        ...
        if symbol is not None:
            market = self.market(symbol)
            request['symbol'] = market['id']
        response = self.privateGetApiV2TradeOrderActive(self.extend(request, params))
        data = self.safe_value(response, 'data')
        if since is not None or limit is not None:
    ...
    def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = self.privateGetApiTradeMatchAccountMatches(self.extend(request, params))
        trades = self.safe_value(response, 'data', [])
