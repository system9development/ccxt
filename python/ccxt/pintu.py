...
class pintu(Exchange):
    ...
    def fetch_markets(self, params={}):
       ...
       """
        response = self.publicGetPublicGetSymbolsReference()
    ...
    def fetch_balance(self, params={}):
       ...
       """
        self.load_markets()
        response = self.privatePostPrivateGetAccountInformation()
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
       ...
       """
        ...
        response = self.privatePostPrivatePlaceOrder(self.extend(request, params))
        timestamp = self.safe_timestamp(response, 'timestamp')
    ...
    def fetch_orders(self, symbol, since=None, limit=None, params={}):
        """
    ...
    def fetch_my_trades(self, symbol, since=None, limit=None, params={}):
       ...
       """
        ...
        if limit is not None:
            # pagination can be controlled with params.page, e.g. {page: 2}
            request['page_size'] = limit
        response = self.privatePostPrivateGetTradeHistory(self.extend(request, params))
    ...
    def fetch_order(self, id, symbol, params={}):
       ...
       """
        ...
        if clientOrderId:
            ...
            request['order_id'] = id
        response = self.privatePostPrivateGetOrderDetails(self.extend(request, params))
        data = self.safe_value(response, 'data', {})
