...
var osl$1 = require('./abstract/osl.js');
var number = require('./base/functions/number.js');
var sha512 = require('./static_dependencies/noble-hashes/sha512.js');

//  ---------------------------------------------------------------------------
class osl extends osl$1 {
    describe() {
        return this.deepExtend(super.describe(), {
            ...
            'urls': {
                'api': {
                    ...
                    '2': 'https://trade-sg.osl.com/api/2',
                    '3': 'https://trade-sg.osl.com/api/3',
    ...
    sign(path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (type === 'private') {
            ...
            if ((method === 'GET') || (method === 'DELETE')) {
                ...
                const data = method + this.encode('/api' + '/' + version + '/' + path) + this.encode(tonce.toString());
                const signature = this.hmac(this.encode(data), this.base64ToBinary(this.secret), sha512.sha512, 'base64');
                headers['api-signature'] = signature;
            }
            else {
                body = query;
                headers['Content-Type'] = 'application/x-www-form-urlencoded';
                const data = method + this.encode(path) + this.encode(tonce.toString()) + this.encode(JSON.stringify(body));
                const signature = this.hmac(this.encode(data), this.base64ToBinary(this['secret']), sha512.sha512, 'base64');
                headers['api-signature'] = signature;
            }
        }
