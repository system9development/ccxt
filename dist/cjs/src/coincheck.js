...
class coincheck extends coincheck$1 {
    describe() {
        return this.deepExtend(super.describe(), {
            ...
            'markets': {
                'BTC/JPY': this.safeMarketStructure({ 'id': 'btc_jpy', 'symbol': 'BTC/JPY', 'base': 'BTC', 'quote': 'JPY', 'baseId': 'btc', 'quoteId': 'jpy', 'type': 'spot', 'spot': true, 'precision': { 'amount': 0.001, 'price': 1.0, 'base': 0.001, 'quote': 1.0 } }),
                'BRIL/JPY': this.safeMarketStructure({ 'id': 'bril_jpy', 'symbol': 'BRIL/JPY', 'base': 'BRIL', 'quote': 'JPY', 'baseId': 'bril', 'quoteId': 'jpy', 'type': 'spot', 'spot': true, 'precision': { 'amount': 0.001, 'price': 1.0, 'base': 0.001, 'quote': 1.0 } }),
