...
export default class coincheck extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'markets': {
                'BTC/JPY': this.safeMarketStructure ({ 'id': 'btc_jpy', 'symbol': 'BTC/JPY', 'base': 'BTC', 'quote': 'JPY', 'baseId': 'btc', 'quoteId': 'jpy', 'type': 'spot', 'spot': true, 'precision': { 'amount': 0.001, 'price': 1.0, 'base': 0.001, 'quote': 1.0 }}), // the only real pair
                'BRIL/JPY': this.safeMarketStructure ({ 'id': 'bril_jpy', 'symbol': 'BRIL/JPY', 'base': 'BRIL', 'quote': 'JPY', 'baseId': 'bril', 'quoteId': 'jpy', 'type': 'spot', 'spot': true, 'precision': { 'amount': 0.001, 'price': 1.0, 'base': 0.001, 'quote': 1.0 }}), // the only real pair
                ...
                // 'XMR/JPY': { 'id': 'xmr_jpy', 'symbol': 'XMR/JPY', 'base': n'XMR', 'quote': 'JPY', 'baseId': 'xmr', 'quoteId': 'jpy' },
